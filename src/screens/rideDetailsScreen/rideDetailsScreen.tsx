...
const RideDetailsScreen = (props: any) => {
    ...
    <View style={style.container}>
      ...
      <View style={style.subcontainer_3}>
        <View style={style?.locationViewStyle}>
          ...
          <Text style={style?.textStyle}>{baseLocalEng?.pickUpLocation}</Text>
        ...
        <View style={style.btn}>
          <CustomButton
            ...
            onPress={() => {
              console.log(route.params.phoneNumber);
              // Linking.openURL(
              //   `whatsapp://send?text=hello&phone=${route.params.phoneNumber}`,
              // )}
              Linking.openURL(`https://wa.me/${route.params.phoneNumber}`);
            }}></CustomButton>
        </View>
      </View>
    </View>
